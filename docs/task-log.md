...
- 2026-09-25: after T-05/T-06, a row written by the **v1** engine would get `method_version = 'v2'` (column default) and `entered_on` null. Harmless only while the v1 engine does not run: see the pg_cron note above.
